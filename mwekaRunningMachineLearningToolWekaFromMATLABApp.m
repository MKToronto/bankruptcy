classdef mwekaRunningMachineLearningToolWekaFromMATLABApp < handle
    %
    % Usage:
    %     app.mwekaRunningMachineLearningToolWekaFromMATLABApp
    ...
    properties (Constant)
        AppPathBase = {'/mwekaRunningMachineLearningToolWekaFromMATLAB/code'};
        AppClass = 'mwekaRunningMachineLearningToolWekaFromMATLABApp';
        Increment = 1;
        Decrement = 0;
        Version = '13a';
    end
    ...
    methods
        ...
        function obj = mwekaRunningMachineLearningToolWekaFromMATLABApp()
        ...
        function startApp(obj)
            ...
            mlock;
            mwekaRunningMachineLearningToolWekaFromMATLABApp.refcount(obj.Increment);
            ...
            existVal = exist(fullfile(pwd,'mweka')); %#ok<EXIST>
            ...
            if (doesShadowExist && ~pathOne.equals(pathTwo))
                % We are trying to execute the wrong mweka
                errordlg(message('MATLAB:apps:runapp:WrongEntryPoint', 'mweka').getString, ...
