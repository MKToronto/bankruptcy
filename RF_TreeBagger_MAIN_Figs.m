...
%we chose to use 50 trees during the rest of our experiments, as that
%provided optimal stopping criteria, as there was no improvement over time and 
% based on Ockham's razor principle of using the most simple model. Run
% lines 9-12 for this figure. 
...
%the training data. Run lines 15 - 21 for this figure. 
figure;
oobErrorBaggedEnsemble = oobError(Mdl);
plot(oobErrorBaggedEnsemble)
xlabel 'Number of grown trees';
ylabel 'Classification error';
title('Error for both Training Data')

%First used the 'OOBVarImp' function to see the importance of the
%attributes for prediction error in the model. We noticed that every time 
...
%'OOBVarImp'. Conclusion: Consistent with the 'randomness' of the Random
...
%mostly Consistent and the lest important features are mostly
%Consistent. This could be explored more in future work. 
%Run lines 36-51 for figure. 
...
%ROC CURVE: Run lines 170-174 for figure
